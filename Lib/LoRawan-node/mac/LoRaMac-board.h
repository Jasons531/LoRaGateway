 ...
 */
#define LORA_MAX_NB_CHANNELS                      32 

/*!
 * Minimal datarate that can be used by the node
 */
#define LORAMAC_MIN_DATARATE                      DR_0 
//extern uint8_t LORAMAC_MIN_DATARATE;

/*!
 * Minimal datarate that can be used by the node
 */
#define LORAMAC_MAX_DATARATE                      DR_5 
//extern uint8_t LORAMAC_MAX_DATARATE;


/*!
 * Default datarate used by the node
 */
//#define LORAMAC_DEFAULT_DATARATE                    0x0801F3D8 ///DR_1
 ...
 */
#define DR_0                                        0  // SF12 - BW125 //0
#define DR_1                                        1  // SF11 - BW125
#define DR_2                                        2  // SF10 - BW125  
#define DR_3                                        3  // SF9  - BW125 //3
...
// #define RX_WND_2_CHANNEL                                  { 434665000, DR_0 } ///501900000
#define RX_WND_2_CHANNEL                                  { 472100000, DR_2 }  ///505.3  471300000
...
#define BAND1              { 100, TX_POWER_10_DBM, 0,  0 } //  1.0 %

/*!
 * LoRaMac default channels
 */
// Channel = { Frequency [Hz], { ( ( DrMax << 4 ) | DrMin ) }, Band }
#define LC1                { 470300000, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
#define LC2                { 470500000, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
#define LC3                { 470700000, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
