    ...
    case MODEM_LORA:
        {
            ...
            case 9: // 500 kHz
                ...
                break;
						...
						DEBUG(2,"Datarate : %d, PreambleLen : %d\r\n",SX1276.Settings.LoRa.Datarate,SX1276.Settings.LoRa.PreambleLen);
...
void SX1276OnTimeoutIrq( void )
{
    ...
    case RF_TX_RUNNING:
        ...
        if( ( RadioEvents != NULL ) && ( RadioEvents->TxTimeout != NULL ) )
        {
            ...
            DEBUG(2,"Txtimeout LoRa Hardware abnormal\r\n");
        }
        break;
    default:
        break;
